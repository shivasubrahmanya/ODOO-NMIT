...
const ProjectPage: React.FC = () => {
  ...
  const [currentView, setCurrentView] = useState<'board' | 'progress'>('board');
  ...
  const canUpdateTaskStatus = (task: Task) => {
    // Only assigned user can manage their own tasks
      ...
      <header className="project-header">
        ...
        <div className="project-actions">
          <div className="view-toggle">
            ...
            <button 
              className={`view-btn ${currentView === 'progress' ? 'active' : ''}`}
